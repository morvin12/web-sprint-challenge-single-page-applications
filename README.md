...
- makes it easy to build relative route paths and link locations, creating more generalized and flexible code.

1. How would you explain form validation to someone who has never programmed before?

- Form validation makes it so all mandatory fields are filled in. It also prevents security vulnerabilities/

1. In 1-2 sentences, define end to end testing.

- It is method that involves testing an application's workflow from beginning to end. This method basically aims to replicate real user scenarios so that the system can be validated for integration and data integrity.
